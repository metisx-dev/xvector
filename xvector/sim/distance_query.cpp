...
template <typename Float>
void createIndexArrayResult(DistanceQuery* query)
{
...
template <typename Float>
void createVectorArrayResult(DistanceQuery* query)
{
...
void calculateByIndexArray(DistanceQuery* query)
{
...
template <typename Float, xvecDistanceType DistanceType>
void calculateByVectorArray(DistanceQuery* query)
{
...
template <typename Float, xvecDistanceType DistanceType>
void calculateByTargetType(DistanceQuery* query)
{
...
template <typename Float>
void calculateByType(DistanceQuery* query)
{
